            ...
            <div className='flex flex-col justify-around md:flex-row px-10 abtMeContentWrapper'>
                <div className='contentLeft font-poppins'>
                    <text className="">
                        ...
                        <br/>
                        You can find me in wild or in beaches<br/>capturing essence of nature 
                        or 
                        doing some summer-saults <br/>and enjoying with others as I am a National Player in Gymnastics.</span>
                    </text>
                 </div>
                <div className='contentRight font-poppins'>
                    <span className='aboutTextHeadingColor' style={{
                    ...
                    <br/>
                    <text><a href='https://www.leetcode.com/__sunny15__/'><span className='aboutTextHeadingColor'>Leetcode</span> </a>: Top 23.9% <br/>(Global, Rank - 167,627)</text><br/>
                    <br/>
                    <text><a href='https://www.codechef.com\users/sunny_pa_ch/'><span className='aboutTextHeadingColor'>CodeChef</span> </a>: 2⭐️ (Rating- 1431)<br/>(Global Rank - 59084)<br/>(Country Rank - 54364)</text><br/>
                    <br/>
                    <text><a href='https://www.codeforces.com/profile/Sunny__/'><span className='aboutTextHeadingColor'>CodeForces</span> </a>: Newbie <br/>(Rating- 885)</text>
                    <br/>
                    <br/>
